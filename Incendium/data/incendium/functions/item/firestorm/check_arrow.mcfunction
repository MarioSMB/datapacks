...
execute if score $failed in.dummy matches 1.. run tellraw @s [{"translate": "Firestorm", "color": "#ff4400", "bold": true}, " ", {"translate": "can only load", "color":"#eb783f", "bold": "false"}, " ", {"text": "Spectral Arrows", "color":"#eb783f"}]
