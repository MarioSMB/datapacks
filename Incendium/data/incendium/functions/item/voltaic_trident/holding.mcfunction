...
execute if entity @s[predicate=incendium:random/10,predicate=incendium:biome/voltaic_heap] run playsound minecraft:block.beacon.ambient player @a[distance=..7] ~ ~ ~ 2 2
...
execute if entity @s[predicate=incendium:random/10,predicate=incendium:biome/voltaic_heap] run function incendium:item/voltaic_trident/explode/lightning/random_start
