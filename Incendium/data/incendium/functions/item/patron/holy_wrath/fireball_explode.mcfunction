...
summon firework_rocket ~ ~ ~ {Silent:1b,NoGravity:0b,Life:0,LifeTime:0,Motion:[0.0,0.5,0.0],Tags:["d1","cluster"],FireworksItem:{id:firework_rocket,Count:1,tag:{Fireworks:{Explosions:[{Type:4,Colors:[I;16777215],FadeColors:[I;16774502]},{Type:4,Colors:[I;16774502],FadeColors:[I;16777215]}]}}},Tags:['in.holy_wrath_firework']}
