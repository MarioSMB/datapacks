...
execute if score $attack in.inferno matches 0 run tp @s ~ ~ ~ facing entity @p[tag=in.survival_player,distance=1..]
...
execute at @a[tag=in.survival_player,distance=..4] run summon minecraft:small_fireball ~ ~3 ~ {Motion:[0.0,-2.0,0.0],Silent:1b}
