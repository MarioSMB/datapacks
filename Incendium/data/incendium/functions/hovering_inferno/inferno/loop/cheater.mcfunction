...
execute if score $spell_card in.inferno matches 0 if predicate incendium:random/30 run function incendium:hovering_inferno/spell/firework/attack/main
...
execute if score $spell_card in.inferno matches ..1 if predicate incendium:random/20 run function incendium:hovering_inferno/spell/shield_lasers_random/main
execute if score $spell_card in.inferno matches 0 if predicate incendium:random/40 run function incendium:hovering_inferno/spell/summon_vex/main
execute if score $spell_card in.inferno matches ..1 if predicate incendium:random/20 run function incendium:hovering_inferno/spell/summon_blaze/main
